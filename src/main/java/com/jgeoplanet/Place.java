...
public class Place extends GeoPlanetResource {
	...
	/**
	 * Returns a collection of places in the child hierarchy (the child, the child of child, etc.). 
	 * The resources in the collection are short representations of each place (unless a 
	 * long representation is specifically requested).
	 * @return the descendants of this place
	 */
	public PlaceCollection getDescendants() {
