...
public class GeoPlanet {
	 ...
	 */
	public synchronized JSONObject doGet(String path, boolean shortForm) throws GeoPlanetException, PlaceNotFoundException {
		...
		try {
			...
			IOUtils.copy(get.getResponseBodyAsStream(), builder);
